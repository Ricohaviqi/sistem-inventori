...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Agu 2022 pada 17.01
...
CREATE TABLE `produk` (
  `produk: id_produk` int(11) NOT NULL,
  `nama_produk` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
ALTER TABLE `produk`
  ADD PRIMARY KEY (`produk: id_produk`);
...
--
ALTER TABLE `produk`
  MODIFY `produk: id_produk` int(11) NOT NULL AUTO_INCREMENT;
